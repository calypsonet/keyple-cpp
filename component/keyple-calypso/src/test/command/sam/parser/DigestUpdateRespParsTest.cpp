        ...
        namespace keyple {
            namespace calypso {
                namespace command {
                    namespace sam {
                        namespace parser {
                            using DigestUpdateRespPars = keyple::calypso::command::sam::parser::security::DigestUpdateRespPars;
...
{
    std::shared_ptr<DigestUpdateRespParsTest> LocalTest = std::make_shared<DigestUpdateRespParsTest>();
