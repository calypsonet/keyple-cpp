            ...
            namespace example {
                namespace generic {
                    namespace common {
                        ...
                        CustomProtocols::CustomProtocols(const std::string &NameValue, InnerEnum innerEnum, const std::string &name) : ordinalValue(nextOrdinal++)// : nameValue(name)
                        {
                            (void)NameValue;
                            nameValue = name;
                        ...
                        CustomProtocols CustomProtocols::valueOf(const std::string &name)
                        {
                            ...
                            return CustomProtocols::valueList[0];
                        }
                    }
                }
            }
