    ...
    namespace eclipse {
        namespace keyple {
            namespace example {
                namespace generic {
                    namespace common {
                        using CustomProtocols = org::eclipse::keyple::example::generic::common::CustomProtocols;
                        ...
                        CustomProtocolSetting::CustomProtocolSetting(const std::string &name, InnerEnum innerEnum, std::shared_ptr<org::eclipse::keyple::seproxy::protocol::SeProtocol> flag, const std::string &value) : ordinalValue(nextOrdinal++)//, 
                        {
                        ...
                        CustomProtocolSetting CustomProtocolSetting::valueOf(const std::string &name) 
                        {
                            ...
                            std::shared_ptr<CustomProtocolSetting> defaultClass = std::dynamic_pointer_cast<CustomProtocolSetting>(CustomProtocolSetting::valueList[0]);
                            return *defaultClass;
                        }
                    }
                }
